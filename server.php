...
class WebSocket
{
    ...
    const LOG_PATH = 'E:\www\cash\doc\yjf\cb\rest\Public\tmp/';
    ...
    public function __construct($host, $port)
    {
        ...
        $this->sockets[0] = [
            'resource' => $this->master
        ];
        // $pid = posix_getpid();
        $pid = get_current_user();
        $this->debug([
            "server: {$this->master} started,pid: {$pid}"
        ]);
...
$ws = new WebSocket("www.test.com", "8080");